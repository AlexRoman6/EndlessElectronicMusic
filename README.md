# Endless Music #
Nuestra web va a tratar sobre diferentes aspectos de la música electrónica. En la parte pública el usuario va a poder navegar por cada una de las entidades que describiremos más tarde. En la parte privada, el usuario deberá loguearse para tratar diferentes temas con otros usuarios y para poder votar positiva o negativamente las canciones.
